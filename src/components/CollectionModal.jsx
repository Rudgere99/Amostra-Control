      ...
      <div className="modal-card">
        <div className="modal-card__header">
          <div>
            ...
            <h3>Registrar coleta das {row.time}</h3>
          </div>
        ...
        <div className="form-grid">
          ...
          <label>Hora programada<input value={row.time} readOnly /></label>
          <label>Hora real<input value={form.realTime} readOnly /></label>
          ...
          <label className="form-grid__full">Observações / justificativa<textarea value={form.notes} onChange={(e) => setField('notes', e.target.value)} placeholder="Descreva observações ou justificativas" /></label>
        </div>
